...
animal9 = { name: "Regina", age: 3, address: "20 avenue de saint ouen Paris", price: 45, user: User.where('is_owner = true').sample, species: "Dog", quality: "Fierce", description: "I protect your house no matter what" }
