...
animal5 = { name: "Billy", age: 1, address: "2 avenue Montaigne", price: 12, user: User.where('is_owner = true').sample, species: "Goat", quality: "Funny", description: "The goat of your life", review: "Billy ate my shoes but we had a very great family moment by Caroline" }
...
animal8 = { name: "Lambert", age: 6, address: "2 villa Adrienne Simon", price: 27, user: User.where('is_owner = true').sample, species: "Goat", quality: "Playfull", description: "I love to play with your shoes", review: "Lambert was a great compagnion when my girlfriend was in Milan by Sam" }
